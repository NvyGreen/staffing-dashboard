...
def get_job(job_id):
    query = """SELECT client_id, position_title, staff_type, location, bill_rate, pay_rate, currency, start_date, end_date, staff_needed, notes FROM job WHERE job_id = :job_id;"""
...
def update_job(job_id, update_info):
    query = """UPDATE job SET client_id = :client_id, position_title = :title, staff_type = :staff_type, location = :location, bill_rate = :bill_rate, pay_rate = :pay_rate, currency = :currency, start_date = :start_date, end_date = :end_date, staff_needed = :staff_needed, notes = :notes, updated_at = :updated_at WHERE job_id = :job_id;"""
    values = {
        "job_id": job_id,
        ...
        "staff_needed": update_info.staff_needed,
        "updated_at": update_info.updated_at.isoformat()
    }
